    ...
    class BBoxTool:
        ...
        def update_display_with_mask(self):
            ...
            try:
                ...
                if self.current_mask is not None and self.show_preview.get():
                    ...
                    mask_overlay[self.current_mask == 1] = [0, 0, 255]  # Red overlay
                    alpha = 0.5
        ...
        def request_live_mask(self):
            ...
            try:
                ...
                if mask is not None:
                    print(f"Generated mask with shape: {mask.shape}")  # Debug
                    print("Putting mask into update queue...")  # Debug
                    self.current_mask = mask
                    self.update_display_with_mask()
                    print("Successfully queued mask")  # Debug
                else:
